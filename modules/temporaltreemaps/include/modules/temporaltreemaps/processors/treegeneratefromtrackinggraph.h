...
protected:
    ...
    /// Updated the component colormap
    void UpdateCompColorMap();
...
public:
    ...
    /// All things contentious color map
    CompositeProperty propSamplingContColormap;

    /// Use continious color map for values
    BoolProperty propUseContColormap;

    /// Continuous colormap
    TransferFunctionProperty propContColormap;

    /// Data range covered by continuous colormap
    DoubleMinMaxProperty propDataRange;

	/// Action: Sample Iso values uniformly in this value range
	ButtonProperty propSampleUniformlyInValueRange;

    /// Color for 0 component or values outside data range
    FloatVec4Property propNoCompColor;

	/// Use nearest Neighbor Interpolation for output?
    BoolProperty propNearestNeighborInterpolation;
	...
	/// Colors for this isoValues
    CompositeProperty propHierarchyColorLevelGroup;
    ...
    /// Scan automatically on changing data
    BoolProperty propActionAutomatically;
