...
public:
    NTGRenderer(InviwoApplication* app);
...
public:
	...
	/// Load the tree string from an intermediate js file
	BoolProperty propLoadFromFile;
	...
	// Use color brewer scales
    BoolProperty propUseColorPreset;
    OptionPropertyInt propColorBrewerScheme;
    // Group of isovalues
    CompositeProperty propHierarchyLevelGroup;
    // Number of isovalues in NTG
    ...
    // Individual properties so that these can be linked to the HTML
