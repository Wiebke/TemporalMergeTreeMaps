...
# TODO: Change to processor that has a transfer function
tf = inviwopy.app.network.VolumeSliceViewer2.tfGroup.transferFunction
tf.clear()
...
# TODO: Change file
path = r"C:\Users\Wiebke\Downloads\pale-sat-blue-rainbow.xml"
mycmap = make_cmap(path)
plot_cmap(mycmap)
...
#    args = parser.parse_args()
    ...
    ## mycmap is matplotlib compatible object. to query color value out of it: print 'example rgba value for data value 0 is: ' + str(mycmap(0.0))

    ## MATLAB Users: This fuction will output a RGB matrix to use in MATLAB if args.matrix == True: print_cmap_matrix(mycmap)

    ## Plotting the colormap to test the conversion plot_cmap(mycmap)

### Alternative, matplotlib color map
#cmapName = "viridis"
#mycmap=plt.get_cmap(cmapName)
